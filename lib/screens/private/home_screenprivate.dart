...
import 'package:todo_app/screens/private/favoriteScreen.dart';
...
class HomeScreenprivate extends StatefulWidget {

  @override
  State<HomeScreenprivate> createState() => _HomeScreenprivateState();
}

class _HomeScreenprivateState extends State<HomeScreenprivate> {
        ...
        child: Column(
          ...
          children: [
            GetBuilder<CreateDataBaseControllerprivate>(builder: ( controller) {
              print(controller.privatelist.toString());
              bool ahmed=false;
              return (controller.privatelist.isEmpty)? Container(
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Card(
                          ...
                          color: col.backColor[controller.privatelist[index]['color']],
                          child: Padding(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Center(child: Text(controller.privatelist[index]['title'].toString(),style:const TextStyle(
                                            fontSize: 18,
                                            fontWeight: FontWeight.bold
                                          ),)),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(controller.privatelist[index]['note'].toString()),
                                          ...
                                          Row(
                                            children: [
                                              Text('Password:'),
                                              const SizedBox(width: 10,),
                                              Text(controller.privatelist[index]['password'].toString()),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(controller.privatelist[index]['start'].toString()),
                                              const SizedBox(width: 10,),
                                              Text(controller.privatelist[index]['date'].toString()),
