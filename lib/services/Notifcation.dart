...
import 'package:todo_app/services/Notfiacation_Screen.dart';
...
class NotifyHelper {
  ...
  scheduledNotification(int hour, int minutes,int id ,String title,String note,int remind,String repeat,String date,String Start) async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      _nextInstanceOfTenAM(
          hour, minutes, remind,repeat, date),
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
    ...
    var formattedDate = DateFormat.yMd().parse('7/24/2022');
    ...
    print('schedual date = $scheduledDate');
  ...
  tz.TZDateTime afterRemind(int remind, tz.TZDateTime scheduledDate) {
    if (remind == 5) {
      scheduledDate = scheduledDate.subtract(const Duration(seconds: 1));
    }
    if (remind == 10) {
